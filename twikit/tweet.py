...
class Tweet:
    ...
    def __init__(self, client: Client, data: dict, user: User = None, probable_spam: bool = False, limited_actions: list[str] = None) -> None:
        self._client = client
        self._data = data
...
def tweet_from_data(client: Client, data: dict, probable_spam: bool = False) -> Tweet:
    ...
    return Tweet(client, tweet_data, User(client, user_data), probable_spam, limited_actions)
